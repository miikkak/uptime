...
dependencies {
    ...
    // velocity-api:4.1.0's own gson dependency to (verify with `./gradlew dependencies
    ...
    // Still gson 2.14.0 after the 4.0.0 -> 4.1.0 bump, so the prior verification still holds.
